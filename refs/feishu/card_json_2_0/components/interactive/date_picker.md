...
**注意事项**：本文档介绍日期选择器组件的 JSON 2.0 结构，要查看历史 JSON 1.0 结构，参考[日期选择器](https://open.larkoffice.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-components/interactive-components/date-picker)。
